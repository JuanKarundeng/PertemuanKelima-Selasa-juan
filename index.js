...
let number2 = 20;
const number3 = 30;
// const pi = 3.14, pi itu contoh variabel yang nd akan diubah, jadi cocok pakai const

var number1 = 40; //tidak disarankan
number2 = 50;
//number3 = 30; so pasti 30, karena dari deklarasi itu number3 pke const, makanya so pasti 30, nd akan diubah karena pke const
...
if (language === "English") {
    console.log("Good Morning"); //karena tidak memenuhi dan tdk ada else, jadi bagian ini akan di skip, dan lnjut ke step brkut, dan tdk eror
}
